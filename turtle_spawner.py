...
class TurtleSpawnernode(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter("spawn_frequency", 0.3)
        ...
        self.catch_turtle_ = self.create_service(CatchTurtle , "catch_turtle",self.callback_catch_turtle_)
    ...
    def callback_call_spawn_service(self,future,request):
        ...
        if response.name !="":
            self.get_logger().info("New_alive_turtle:" + response.name)
            new_turtle = Turtle()
